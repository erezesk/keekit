...
class AdvertisementsControllerTest < ActionController::TestCase
  ...
  test "should create advertisement" do
    assert_difference('Advertisement.count') do
      post :create, advertisement: { active: @advertisement.active, name: @advertisement.name, rating: @advertisement.rating, ratings_count: @advertisement.ratings_count, type: @advertisement.type, views: @advertisement.views }
    end
  ...
  test "should update advertisement" do
    put :update, id: @advertisement, advertisement: { active: @advertisement.active, name: @advertisement.name, rating: @advertisement.rating, ratings_count: @advertisement.ratings_count, type: @advertisement.type, views: @advertisement.views }
    assert_redirected_to advertisement_path(assigns(:advertisement))
  end
